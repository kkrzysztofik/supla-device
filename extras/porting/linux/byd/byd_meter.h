...
#ifndef EXTRAS_PORTING_LINUX_BYD_BYD_METER_H_
#define EXTRAS_PORTING_LINUX_BYD_BYD_METER_H_
...
class BydMeter : public Supla::Sensor::GeneralPurposeMeter {
 public:
  BydMeter(Supla::Linux::Byd::BydAccountConfig account,
...
#endif  // EXTRAS_PORTING_LINUX_BYD_BYD_METER_H_
